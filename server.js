  ...
  return `
    ...
    <head>
      ...
      <style>
        ...
        .analysis-box { background: rgba(255, 255, 255, 0.05); border-left: 4px solid ${daColor}; padding: 30px; border-radius: 0 16px 16px 0; }
        .analysis-item { font-size: 19px; line-height: 1.6; }
